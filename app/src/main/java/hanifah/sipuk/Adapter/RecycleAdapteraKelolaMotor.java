...
import hanifah.sipuk.DetailMotorAdmin;
 ...
 */
public class RecycleAdapteraKelolaMotor extends RecyclerView.Adapter<RecycleViewHolderPilihMotor> {
    ...
    public RecycleAdapteraKelolaMotor(final Context context) {
    ...
    View.OnClickListener clicklistener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            i  = new Intent(context, DetailMotorAdmin.class);
